...
**Next Steps:** [Work item: proceed to `/_my_design`. Shaping tier: feed into `/_my_concept_design` or `/_my_epic_plan`.]
```
...
**Related Commands:**
- Before product design: `/_my_concept` (shaping tier) or `/_my_spec` (work item)
- After product design: `/_my_concept_design` or `/_my_epic_plan` (shaping tier); `/_my_design` (work item)
