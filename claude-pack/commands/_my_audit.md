...
Two scopes:
- **Work item** (`/_my_audit {item}`): evaluate one item against its plan, spec, and design.
- **Epic** (`/_my_audit {epic}`): review all items in an epic and assess against source documents.
