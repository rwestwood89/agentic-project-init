...
If `User-provided arguments are supplied when this skill is invoked.` names a file path or concept name, use it. If ambiguous or missing, scan `.project/concepts/` and `.project/research/` and ask the user which files are the source material for this epic.
