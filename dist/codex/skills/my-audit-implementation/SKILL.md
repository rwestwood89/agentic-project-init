---
name: my-audit-implementation
description: Audit completed work against an implementation plan. Use when you need a post-implementation gap check against plan phases.
---

Generated from `claude-pack/commands/_my_audit_implementation.md`. This is a command-derived Codex skill. Rebuild it instead of editing it by hand.
...
**Related Commands:** ``my-implement`` → ``my-audit-implementation`` → ``my-code-review``
