---
name: my-spec
description: Create a feature specification with goals and acceptance criteria. Use when a feature needs requirements clarified and documented.
---
...
**Related Commands:**
- Before spec: ``my-research`` for exploration
