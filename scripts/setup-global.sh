...
echo ""
echo "Optional: Install the File-Native Comment System"
echo "  $SCRIPT_DIR/setup-comments.sh"
echo "  $SCRIPT_DIR/setup-comments.sh --vscode   (includes VSCode extension)"
